...
This project is a minimal Electron + Node.js + SQLite desktop app that monitors configured web pages, listens to network request headers, and stores those values locally for inventory synchronization workflows.
